        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReadingStreakDays = table.Column<int>(type: "int", nullable: false),
                    TotalBooksRead = table.Column<int>(type: "int", nullable: false),
                    TotalPagesRead = table.Column<int>(type: "int", nullable: false),
                    AverageDaysToFinish = table.Column<double>(type: "float", nullable: false),
                    PhysicalBooksRead = table.Column<int>(type: "int", nullable: false),
                    DigitalBooksRead = table.Column<int>(type: "int", nullable: false),
                    AverageUserRating = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookshelfEntries_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookshelfEntries_BookId",
